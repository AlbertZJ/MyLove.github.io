function showTime() { 
	...
	var startDate = new Date(2023, 03, 15);
	...
	if (seconds < 10) 
	seconds = "0" + seconds; 
	var currentTimeString = "Dear 小财迷:<br>"
		+ "我们相爱了:<br> "
		...
		+	"<c style=\"color: #CCCCCC; text-shadow:2px 3px 3px #222; font-family:Microsoft YaHei; font-size:20px\" >----糙汉子   2023-05-20</c>"; 
